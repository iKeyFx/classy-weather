  ...
  render() {
   return (
    <div className="app">
      ...
      {this.state.weather.weathercode && <Weather location={this.state.displayLocation} weather={this.state.weather}/>}
    </div>
   )
  }
}
  ...
  render() {
    ...
    return (
     <li className="day">
      ...
      <p>
        {Math.floor(min)}&deg; &mdash; <strong>{Math.ceil(max)}&deg;
        </strong>
      </p>
     </li>
  )
